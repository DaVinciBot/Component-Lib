<script lang="ts">
	import MfaEnrollModal from '$lib/modals/MfaEnrollModal.svelte';
	import PasskeyNameModal from '$lib/modals/PasskeyNameModal.svelte';
	import PasskeysManageModal from '$lib/modals/PasskeysManageModal.svelte';
	import RecoveryCodesModal from '$lib/modals/RecoveryCodesModal.svelte';
	import TotpEnrollModal from '$lib/modals/TotpEnrollModal.svelte';
