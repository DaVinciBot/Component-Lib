<script lang="ts">
	import ConnectionsSection from '$lib/settings/ConnectionsSection.svelte';
	import MfaSection from '$lib/settings/MfaSection.svelte';
	import SessionsSection from '$lib/settings/SessionsSection.svelte';
	import StepUpDialog from '$lib/settings/StepUpDialog.svelte';
