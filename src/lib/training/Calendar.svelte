...
<script lang="ts">
	...
	import Spinner from '$lib/share/Spinner.svelte';
	import {
		filterSlotsByFormat,
		getCalendarDays,
		getWeekNumber,
		...
		toDateKey,
		weekdays
	} from '$lib/training/helpers/calendar';
	import { calendarFilters } from '$lib/training/stores/trainingCalendarFilters';
	import TrainingCard from '$lib/training/TrainingCard.svelte';
	import TrainingSlotModal from '$lib/training/TrainingSlotModal.svelte';
